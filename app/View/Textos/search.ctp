<section>
<div class="row">
    <a class="button excluirtudoimg" href="/Textos/delete/ <?php echo $dados[0]["textos"]["id"]; ?>">Excluir texto com todas as Imagens</a><br>
    ...
    <form action="/Textos/edit" method="POST" name="adm" id="formtextoedit" enctype="multipart/form-data">
        ...
        <form action="/Libras/editlibra" method="POST" name="adm" enctype="multipart/form-data">
            ...
            <input class="button-primary" type="submit" value="Add imagens a para esta palavra">
        </form>
        <hr>
    </div>
