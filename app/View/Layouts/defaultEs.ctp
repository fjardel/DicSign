...
<html>
    ...
    <body>
        <header>
            <div id="logobar" class=""> <div id="logotipo"><img src="/img/logos/logo_ufpa.png" width="200" height="60"></div></div>
            <div id="appname">
                <h6>Diccionario Signwriting - dicSign</h6>
                <div class="" id='bandeiras'>
                    ...
                    <a href="?lg=en" ><img src="/img/logos/Bandeira_Estados_Unidos.png" width="25" height="15"></a>
                </div> 
            </div>
        </header>
...
function googleTranslateElementInit() {
  new google.translate.TranslateElement({pageLanguage: 'pt', includedLanguages: 'en,es', layout: google.translate.TranslateElement.FloatPosition.TOP_LEFT}, 'google_translate_element');
            ...
            <div id="info" class="">
                ...
                <div class="menubaixo"><a href="javascript:;" >Retroalimentación</a></div>
                <div class="espaco"> Copyrigth © 2015 DicSign. Todos los derechos reservados.</div>
                <div class="" id='logoinfer'>
                    <a href="http://www.ufpa.br" ><img src="/img/logos/ufpa.png" width="50" height="45"></a>
                    <a href="http://www.geira.com.br/ICPEE/" ><img src="/img/logos/logo_geira.png" width="75" height="45"></a>
                    <a href="http://www.proeg.ufpa.br" ><img src="/img/logos/logo_proeg.png" width="75" height="45"></a>
                </div>
            </div>
        </footer>
    </body>
